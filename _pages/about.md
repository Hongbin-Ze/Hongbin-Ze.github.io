...
<ul class="patents-list">
    <li>
        <div class="patent">
            <p>
                Yuegang Sun, Linchun Sun, <strong>Hongbin Na</strong>, Yingjun Zhang.
                Random font style generation method and system for expanding OCR training set
                <em>Google Patents</em> (Publication of CN115620307B).
                <a href="https://patents.google.com/patent/CN115620307A/en">[Link]</a>.
            </p>
        </div>
    </li>
    <!-- 其他论文可以作为额外的 <li> 项添加 -->
